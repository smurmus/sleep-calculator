...
<div style={{ display: 'flex', flexWrap: 'wrap' }}>
    <img src="assets/images/empty-state.png" alt="Empty state" width="300px" height="auto" />
    <img src="assets/images/button-loading.png" alt="Loading state" width="300px" height="auto" />
    <img src="assets/images/score-success.png" alt="Success state" width="300px" height="auto" />
    <img src="assets/images/form-error.png" alt="Error state from form" width="300px" height="auto" />
    <img src="assets/images/api-error.png" alt="Error state from API" width="300px" height="auto" />
    <img src="assets/images/disable-time-asleep-opts.png" alt="Disabled options for time asleep" width="300px" height="auto" />
</div>
